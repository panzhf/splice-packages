<template>
  <view class="u-select">
    <u-mask :mask-click-able="true" :duration="50" :z-index="100" :show="value" />
    <view v-show="value" class="select-address">
      <view class="u-select">
        <view class="u-select__header select-header" @touchmove.stop.prevent="() => {}">
          <view
            class="u-select__header__cancel u-select__header__btn select-btn"
            style="color: #666"
          ...
          <view
            class="u-select__header__confirm u-select__header__btn select-btn"
        ...
        <view class="u-select__body">
          <view v-if="loading" class="s-loading"><u-loading color="#999999" mode="circle" /></view>
          <picker-view
          ...
          >
            <picker-view-column
              ...
              :key="index"
              :class="columnCount && index + 1 > columnCount ? 'column-hidden' : ''"
            >
  ...
  methods: {
    ...
    setColumnNum() {
      ...
      // 多列联动时，通过历遍this.list的第一个元素，得出有多少列
        ...
        // 只要有元素并且第一个元素有children属性，继续历遍 修改
        while (column[0][this.childName] && column[0][this.childName].length) {
